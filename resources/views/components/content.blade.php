    ...
    <div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
        ...
        <div class="space-y-8 lg:grid lg:grid-cols-3 sm:gap-6 xl:gap-10 lg:space-y-0">
            ...
            <div class="flex flex-col p-6 mx-auto max-w-lg text-center text-white rounded-lg border shadow border-gray-600 xl:p-8 bg-gray-800 dark:text-white">
                ...
                <p class="font-light sm:text-lg text-gray-400">Best option for personal use & for your next project.</p>
            ...
            <div class="flex flex-col p-6 mx-auto max-w-lg text-center text-white rounded-lg border shadow border-gray-600 xl:p-8 bg-gray-800 dark:text-white">
                ...
                <p class="font-light sm:text-lg text-gray-400">Relevant for multiple users, extended & premium support.</p>
                <div class="flex justify-center items-baseline my-8">
             ...
             <div class="flex flex-col p-6 mx-auto max-w-lg text-center text-white rounded-lg border shadow border-gray-600 xl:p-8 bg-gray-800 dark:text-white">
                ...
                <p class="font-light sm:text-lg text-gray-400">Best for large scale uses and extended redistribution rights.</p>
                <div class="flex justify-center items-baseline my-8">
